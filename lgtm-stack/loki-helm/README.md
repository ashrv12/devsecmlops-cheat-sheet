NAME: loki
LAST DEPLOYED: Wed Mar 11 14:12:02 2026
...
Watch the deployment status using the command: kubectl get pods -w --namespace openshift-distributed-tracing
...
http://loki-gateway.openshift-distributed-tracing.svc.cluster.local/loki/api/v1/push

You can test to send data from outside the cluster by port-forwarding the gateway to your local machine:

kubectl port-forward --namespace openshift-distributed-tracing svc/loki-gateway 3100:80 &
...
http://loki-gateway.openshift-distributed-tracing.svc.cluster.local/
